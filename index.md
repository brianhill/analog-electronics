...
* There was a Frankenstein era going all the way back to the roots of the field where devices were expensive, dangerous, not very capable, and initially not very widespread. As vacuum tubes became mass produced in the 1920s, the Frankenstein era started to close.
* From 1947 onward, when the transistor was invented, and immediately began to obsolete the previous high-voltage vacuum tubes. Transistors and diodes in myriad variety were developed, all dependent on a new material known as a semiconductor. This ushered in a Goldilocks era, where it became far easier to build circuits.
* In the 1980s, the success of the semiconductor era ushered in the present era. The discrete transistor was almost completely replaced by miniature versions of itself replicated *en masse* in integrated circuits and silicon wafers, and even in the most mundane circuitry like that in toasters and thermostats, the componentry became hidden in epoxy-coated boxes that the consumer had no way and little reason to tinker with.
...
The only prerequisite for this class is good high school mathematics. When I say &ldquo;high school mathematics&ldquo; I am specifically distinguishing it from &ldquo;college mathematics&rdquo; even though many students on a college prep track take AP calculus while still in high school. More formally, what I am referring to by &ldquo;high school mathematics&rdquo; is the four years consisting of: Algebra I; Geometry (plane geometry with proofs); Algebra II (with trigonometry); and Precalculus (logarithms, exponentials, polynomials, rational functions, and infinite sequences and series). Good high school mathematics will make the mathematical descriptions of analog circuitry readily intelligible.
...
* Unit 11: Special Project: FM receiver kit

## Grading

* 60% lab assignments (demonstration of your circuity in almost every class)
* 25% written problem sets (where you will practice and demonstrate your understanding of circuit diagrams and theory)
* 15% final project (the last 3 of our 14 weeks) &mdash; most of April &mdash; will be devoted to building an AM/FM receiver from a kit
